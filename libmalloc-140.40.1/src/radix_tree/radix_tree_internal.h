...
#define RADIX_LABEL_BITS 11 //max number of label bits per edge 每个边的最大 标号位的数量
#define RADIX_TREE_KEY_BITS (64 - 12) //number of keybits we use (starting from MSB)。使用的 关键位的数量
