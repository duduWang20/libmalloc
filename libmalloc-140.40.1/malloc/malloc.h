...
typedef struct _malloc_zone_t {
	...
	/* same as malloc, but block returned is set to zero 清零 */
    void 	*(*valloc)(struct _malloc_zone_t *zone, size_t size);
	/* same as malloc, but block returned is set to zero and is guaranteed to be page aligned 清零+对齐*/
    ...
    unsigned	(*batch_malloc)(struct _malloc_zone_t *zone,
					...
					/* given a size,
						returns pointers capable of holding that size;
